        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Product>().HasData(
                new Product { Id = 1, Name = "dōTERRA Peppermint Touch", ScientificName = "Mentha piperita", 
                            ...
                            Benefits = "Ajuda a reduzir sentimentos de tensão.", AromaticDescription = "Mentolado, fresco, herbáceo",
                            Ingredients = "Óleo de coco, Óleo de Mentha piperita.", Uses = "Esfregue nas têmporas quando " +
                            "estiver estudando ou ao acordar, para um reforço de energia durante a manhã.", HowToUse = "Esfregue " +
                            "nas têmporas quando estiver estudando ou ao acordar, para um reforço de energia durante a manhã.", Precautions = "Uso Externo. " +
